...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        try:
            ...
            elem = driver.find_element(By.XPATH,
                                       '/html/body/section/div/a[2]')
            elem.send_keys(Keys.RETURN)
            print("Test passed - drinks menu list displayed")
            assert True

        except NoSuchElementException:
            self.fail("drinks menu list is not displayed when Burgers is clicked from menu - test failed")
